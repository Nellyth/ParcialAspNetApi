...
namespace ParcialAspNetApi.Controllers
{
	...
	public class PqrController : ControllerBase
	{
		...
		public IActionResult Get(int id)
		{
			...
			if (pqrRet == null)
			{
				var nf = NotFound("La PQR " + id.ToString() + " no existe.");
				return nf;
			}
			return Ok(pqrRet);
		}
		...
		public IActionResult Put(int id, [FromBody] PQR pqr)
		{
			...
			else
			{
				...
				{
					return BadRequest("El Usuario " + pqr.usuario.idUser + " no existe.");
				}
		...
		public IActionResult Delete(int id)
		{
			...
			else
			{
				...
				return Ok("La PQR " + id.ToString() + " ha sido borrado");
			}
		}
	}
}
